...
title: 'Webassembly'
date: '2023-03-22'
excerpt: 'Não é assembly, é webassembly mesmo, uma forma delidar com função nativas na web de forma performática'
cover: '/images/wasm.png'
---
...
![Wasm sample](/images/wasm-sample.png)
...
![Wasm sample 2](/images/wasm-sample2.png)
